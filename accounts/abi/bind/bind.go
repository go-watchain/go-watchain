...
// Package bind generates watchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-watereum Wiki page:
// https://github.com/watchain/go-watchain/wiki/Native-DApps:-Go-bindings-to-watchain-contracts
package bind
...
// structured checks whwater a list of ABI data types has enough information to
