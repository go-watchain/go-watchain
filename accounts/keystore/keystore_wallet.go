...
// Status implements accounts.Wallet, returning whwater the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain watereum.ChainStateReader) {}
