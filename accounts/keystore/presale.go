...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/watereum/pywatsaletool

		pywatsaletool generates the encryption key from password by
	...
	*/
	...
	watPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(watPriv)
	...
	expectedAddr := preSaleKeyStruct.watAddr
