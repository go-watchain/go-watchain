...
# 1. install gwat for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gwat
# 5. create gwat, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable watEREUM_SOCKET
...
!define GROUPNAME "watchain"
!define APPNAME "Gwat"
!define DESCRIPTION "Official Go implementation of the watchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gwat is installed global
