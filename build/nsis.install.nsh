Name "gwat ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/watchain/go-watchain/issues"
!define UPDATEURL "https://github.com/watchain/go-watchain/releases"
!define ABOUTURL "https://github.com/watchain/go-watchain#watereum-go"
...
# Install gwat binary
Section "Gwat" Gwat_IDX
  SetOutPath $INSTDIR
  file {{.Gwat}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gwat.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gwat.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gwat incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gwat outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gwat UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gwat incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gwat.exe" "" "" "watchain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gwat outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gwat.exe" "" "" "watchain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gwat UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gwat.exe" "" "" "watchain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/watereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "watEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gwat.ipc"
  ${EnvVarUpdate} $0 "watEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gwat.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Gwat_IDX}
    SectionGetSize ${Gwat_IDX} $0
