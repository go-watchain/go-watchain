...
// returned from docker inspect, parsed into a form easily usable by puppwat.
type containerInfos struct {
	running bool              // Flag whwater the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whwater there's a container running for the service
	...
	// Infos retrieved, parse the above into somwating meaningful
