...
// This is a simple Whisper node. It could be used as a stand-alone boowatrap node.
...
import (
	...
	"github.com/watchain/go-watchain/whisper/mailserver"
	whisper "github.com/watchain/go-watchain/whisper/whisperv6"
...
// cmd arguments
var (
	boowatrapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the boowatrap server")
	...
	argEnode   = flag.String("boot", "", "boowatrap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *boowatrapMode {
		configureNode()
		fmt.Println("Boowatrap Whisper node started")
	} else {
