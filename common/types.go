...
func (h *Hash) Sewatring(s string) { h.SetBytes([]byte(s)) }
...
// Address represents the 20 byte address of an watchain account.
...
// IsHexAddress verifies whwater a string can represent a valid hex-encoded
// watchain address or not.
...
func (a *Address) Sewatring(s string) { a.SetBytes([]byte(s)) }
