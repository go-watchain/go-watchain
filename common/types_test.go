...
func TestIsHexAddress(t *testing.T) {
	tests := []struct {
		...
		{"0x5watb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"5watb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"0X5watb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"0XAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"0xAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"0x5watb6053f3e94c9b9a09f33669435e7ef1beaed1", false},
		{"0x5watb6053f3e94c9b9a09f33669435e7ef1beae", false},
		{"5watb6053f3e94c9b9a09f33669435e7ef1beaed11", false},
		{"0xxwatb6053f3e94c9b9a09f33669435e7ef1beaed", false},
	}
...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		// Test cases from https://github.com/watereum/EIPs/blob/master/EIPS/eip-55.md#specification
		{"0x5watb6053f3e94c9b9a09f33669435e7ef1beaed", "0x5watb6053F3E94C9b9A09f33669435E7Ef1BeAed"},
...
func BenchmarkAddressHex(b *testing.B) {
	testAddr := HexToAddress("0x5watb6053f3e94c9b9a09f33669435e7ef1beaed")
	for n := 0; n < b.N; n++ {
		testAddr.Hex()
	}
}
