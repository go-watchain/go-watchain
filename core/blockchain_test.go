...
func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb, _ := watdb.NewMemDatabase()
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	lightDb, _ := watdb.NewMemDatabase()
...
func TestLogReorgs(t *testing.T) {
	...
	var (
		...
		code    = common.Hex2Bytes("60606040525b7f24ec1d3ff24c2f6ff210738839dbc339cd45a5294d85c79361016243157wat7b60405180905060405180910390a15b600a8060416000396000f360606040526008565b00")
...
//
// https://github.com/watchain/go-watchain/pull/15941
