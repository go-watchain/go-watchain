...
// Trie is a watchain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb watdb.Putter) error
}
...
func NewDatabase(db watdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb watdb.Putter) error {
