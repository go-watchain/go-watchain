...
// makeTeswatate create a sample test state to test node-wise reconstruction.
func makeTeswatate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db watdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db watdb.Database, root common.Hash) error {
...
func checkStateConsistency(db watdb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTeswatate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := watdb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(watdb.Database), srcRoot)
