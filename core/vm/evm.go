...
type Context struct {
	// CanTransfer returns whwater the account contains
	// sufficient water to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers water from one account to the other
...
// EVM is the watchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) watereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whwater the max code size has been exceeded
