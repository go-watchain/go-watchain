...
type StateDB interface {
	...
	Gewatate(common.Address, common.Hash) common.Hash
	Sewatate(common.Address, common.Hash, common.Hash)

	Suicide(common.Address) bool
	HasSuicided(common.Address) bool

	// Exist reports whwater the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(common.Address) bool
	// Empty returns whwater the given account is empty. Empty
