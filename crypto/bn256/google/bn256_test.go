...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Sewatring("23423492374", 10)
	a.y.Sewatring("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Sewatring("239487238491", 10)
	a.x.y.Sewatring("2356249827341", 10)
	a.y.x.Sewatring("082659782", 10)
	a.y.y.Sewatring("182703523765", 10)
	a.z.x.Sewatring("978236549263", 10)
	a.z.y.Sewatring("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Sewatring("239846234862342323958623", 10)
	a.x.x.y.Sewatring("2359862352529835623", 10)
	a.x.y.x.Sewatring("928836523", 10)
	a.x.y.y.Sewatring("9856234", 10)
	a.x.z.x.Sewatring("235635286", 10)
	a.x.z.y.Sewatring("5628392833", 10)
	a.y.x.x.Sewatring("252936598265329856238956532167968", 10)
	a.y.x.y.Sewatring("23596239865236954178968", 10)
	a.y.y.x.Sewatring("95421692834", 10)
	a.y.y.y.Sewatring("236548", 10)
	a.y.z.x.Sewatring("924523", 10)
	a.y.z.y.Sewatring("12954623", 10)
