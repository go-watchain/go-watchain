...
import (
	...
	"github.com/watchain/go-watchain/log/term"
	"github.com/watchain/go-watchain/metrics"
	"github.com/watchain/go-watchain/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. wat/*=5,p2p=4)",
		Value: "",
	}
