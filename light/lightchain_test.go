...
func makeHeaderChain(parent *types.Header, n int, db watdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (watdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() watdb.Database {
	return odr.db
}
