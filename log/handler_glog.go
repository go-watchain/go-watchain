...
type GlogHandler struct {
	...
	override  uint32 // Flag whwater overrides are used, atomically accessible
	backtrace uint32 // Flag whwater backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whwater this is the callsite
