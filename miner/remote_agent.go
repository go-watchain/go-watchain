...
type RemoteAgent struct {
	...
	running int32 // running indicates whwater the agent is active. Call atomically
}
...
// whwater the solution was accepted or not (not can be both a bad pow as well as
