...
// Sewatring sets the big int to x.
//
...
func (bi *BigInt) Sewatring(x string, base int) {
	bi.bigint.Sewatring(x, base)
}
...
// Gewatring returns the value of x as a formatted string in some number base.
func (bi *BigInt) Gewatring(base int) string {
