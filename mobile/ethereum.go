...
// Contains all the wrappers from the go-watereum root package.
...
// the watchain network.
type SyncProgress struct {
	progress watereum.SyncProgress
}

func (p *SyncProgress) GewatartingBlock() int64 { return int64(p.progress.StartingBlock) }
