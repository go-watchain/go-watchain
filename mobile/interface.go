...
func (i *Interface) Sewatring(str string)          { i.object = &str }
func (i *Interface) Sewatrings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaulwatring()    { i.object = new(string) }
func (i *Interface) SetDefaulwatrings()   { i.object = new([]string) }
...
func (i *Interface) Gewatring() string        { return *i.object.(*string) }
func (i *Interface) Gewatrings() *Strings     { return &Strings{*i.object.(*[]string)} }
