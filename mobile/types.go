...
// Transaction represents a single watchain transaction.
...
// Deprecated: use watchainClient.TransactionSender
...
func (r *Receipt) GetPoswatate() []byte         { return r.receipt.Poswatate }
