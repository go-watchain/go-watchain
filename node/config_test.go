...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gwat.ipc", false, filepath.Join(os.TempDir(), "gwat.ipc")},
		{"data", "gwat.ipc", false, "data/gwat.ipc"},
		{"data", "./gwat.ipc", false, "./gwat.ipc"},
		{"data", "/gwat.ipc", false, "/gwat.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gwat.ipc", true, `\\.\pipe\gwat.ipc`},
		{"data", "gwat.ipc", true, `\\.\pipe\gwat.ipc`},
		{"data", `\\.\pipe\gwat.ipc`, true, `\\.\pipe\gwat.ipc`},
	}
