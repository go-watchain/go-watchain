...
// isInitDone returns whwater the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the boowatrapping
		// logic.
		<-tab.refresh()
...
// boowatrap or discarded faulty peers).
