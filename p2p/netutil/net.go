...
// Contains reports whwater the given IP is contained in the list.
...
// IsLAN reports whwater an IP is a local network address.
...
// IsSpecialNetwork reports whwater an IP is located in a special-use network range
...
// CheckRelayIP reports whwater an IP relayed from the given sender IP
...
// SameNet reports whwater two IP addresses have an equal prefix of the given bit length.
...
// Contains whwater the given IP is contained in the set.
