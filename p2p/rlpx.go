...
import (
	...
	"github.com/watchain/go-watchain/crypto/secp256k1"
...
// and also verifies whwater the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whwater read packet had plain format.
