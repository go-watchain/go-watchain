...
import (
	...
	"github.com/watchain/go-watchain/crypto/ecies"
...
var eip8HandshakeAuthTests = []handshakeAuthTest{
	// (Auth₁) RLPx v4 plain encoding
	{
		input: `
			...
			c444f14be226458940d6061c296350937ffd5e3acaceewatfd3c6f74be8e23e0f45163cc7ebd7622
	...
	// (Auth₂) EIP-8 encoding
	{
		input: `
			...
			9634a8c458705bf83a626ea0384d4d7341wat591fae42ce6bd5c850bfe0b999a694a49bbbaf3ef6c
...
var eip8HandshakeRespTests = []handshakeAckTest{
	...
	{
		input: `
			01f004076e58wat772bb101ab1a8e64e01ee96e64857ce82b1113817c6cdd52c09d26f7b90981cd7
