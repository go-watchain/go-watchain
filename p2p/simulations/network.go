...
import (
	...
	"github.com/watchain/go-watchain/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togwater.
//
...
// Connect connects two nodes togwater by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whwater there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whwater or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whwater or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whwater both nodes are currently up
