...
// MainnetBootnodes are the enode URLs of the P2P boowatrap nodes running on
// the main watchain network.
var MainnetBootnodes = []string{
	// watchain Foundation Go Bootnodes
...
// TestnetBootnodes are the enode URLs of the P2P boowatrap nodes running on the
// Ropsten test network.
var TestnetBootnodes = []string{
}

// RinkebyBootnodes are the enode URLs of the P2P boowatrap nodes running on the
// Rinkeby test network.
var RinkebyBootnodes = []string{
}

// DiscoveryV5Bootnodes are the enode URLs of the P2P boowatrap nodes for the
