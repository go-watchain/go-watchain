...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllwatashProtocolChanges, new: AllwatashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllwatashProtocolChanges, new: AllwatashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllwatashProtocolChanges,
