...
func TeswatreamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLiswatream(t *testing.T) {
	ls := NewLiswatream(bytes.NewReader(unhex("0101010101")), 3)
...
func TeswatreamErrors(t *testing.T) {
...
func TeswatreamList(t *testing.T) {
...
func TeswatreamRaw(t *testing.T) {
	tests := []struct {
		input  string
		output string
	}{
