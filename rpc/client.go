...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for watSubscribe requests
}
...
// watSubscribe registers a subscripion under the "wat" namespace.
func (c *Client) watSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "wat", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. watSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through watSubscribe.
