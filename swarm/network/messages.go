...
import (
	...
	"github.com/watchain/go-watchain/swarm/network/kademlia"
	"github.com/watchain/go-watchain/swarm/services/swap"
...
to be used to boowatrap kademlia tables.
...
Timeout serves to indicate whwater the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whwater responder is expected to deliver content
