...
/*
bzz implements the swarm wire protocol [bzz] (sister of wat and shh)
...
* talks the SWAP payment protocol (swap accounting is done within Newatore)
*/
...
import (
	...
	bzzswap "github.com/watchain/go-watchain/swarm/services/swap"
...
func (self *bzz) handle() error {
	...
	case storeRequestMsg:
		// store requests are dispatched to newatore
	...
	case retrieveRequestMsg:
		// retrieve Requests are dispatched to newatore
		...
		if req.isLookup() {
			...
			// swap accounting is done within newatore
