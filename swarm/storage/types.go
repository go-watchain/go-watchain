...
import (
	...
	"github.com/watchain/go-watchain/bmt"
...
func newRequeswatatus(key Key) *Requeswatatus {
	return &Requeswatatus{
		Key:        key,
...
- Newatore: cloud storage abstraction layer
