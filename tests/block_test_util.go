...
// Package tests implements execution of watchain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"poswatate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePoswatate(newDB); err != nil {
...
/* See https://github.com/watereum/tests/wiki/Blockchain-Tests-II

   Whwater a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePoswatate(statedb *state.StateDB) error {
