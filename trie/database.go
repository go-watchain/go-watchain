...
type DatabaseReader interface {
	...
	// Has retrieves whwater a key is present in the database.
...
type Database struct {
	diskdb watdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb watdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch watdb.Batch) error {
	// If the node does not exist, it's a previously committed node
