...
// DefaultConfig contains default settings for use on the watchain main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.watash.DatasetDir = filepath.Join(home, "AppData", "watash")
	} else {
		DefaultConfig.watash.DatasetDir = filepath.Join(home, ".ethash")
	}
}
...
type Config struct {
	...
	// If nil, the watchain main net block is used.
	...
	waterbase    common.Address `toml:",omitempty"`
