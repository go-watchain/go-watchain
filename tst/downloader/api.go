...
// Syncing provides information when this nodes starts synchronising with the watchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  watereum.SyncProgress `json:"status"`
}
