...
type downloadTester struct {
	...
	stateDb watdb.Database // Database used by the tester for syncing from peers
	peerDb  watdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = watdb.NewMemDatabase()
