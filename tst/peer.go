...
// PeerInfo represents a short summary of the watchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // watchain protocol version negotiated
...
// Handshake executes the wat protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("wat/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the watchain sub-protocol.
type peerSet struct {
