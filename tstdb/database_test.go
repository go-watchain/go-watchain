...
func newTestLDB() (*watdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "watdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := watdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db watdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db watdb.Database, t *testing.T) {
	const n = 8
