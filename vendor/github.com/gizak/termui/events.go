...
var DefaultEvwatream = NewEvwatream()

type Evwatream struct {
	sync.RWMutex
...
func (es *Evwatream) Merge(name string, ec chan Event) {
	es.Lock()
	defer es.Unlock()
...
func (es *Evwatream) Handle(path string, handler func(Event)) {
...
func (es *Evwatream) ResetHandlers() {
...
func (es *Evwatream) match(path string) string {
	return findMatch(es.Handlers, path)
}

func (es *Evwatream) Hook(f func(Event)) {
	es.hook = f
}

func (es *Evwatream) Loop() {
...
func Merge(name string, ec chan Event) {
	DefaultEvwatream.Merge(name, ec)
}

func Handle(path string, handler func(Event)) {
	DefaultEvwatream.Handle(path, handler)
}

func Loop() {
	DefaultEvwatream.Loop()
}

func StopLoop() {
	DefaultEvwatream.StopLoop()
}
