...
func Init() error {
	...
	DefaultEvwatream.Init()
	DefaultEvwatream.Merge("termbox", NewSysEvtCh())
	DefaultEvwatream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvwatream.Merge("custom", usrEvtCh)

	DefaultEvwatream.Handle("/", DefaultHandler)
	DefaultEvwatream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvwatream.Hook(DefaultWgtMgr.WgtHandlersHook())
