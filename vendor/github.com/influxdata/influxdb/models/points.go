...
// Gewatring returns the string value for a string key.
func (a Tags) Gewatring(key string) string {
...
// Sewatring sets the string value for a string key.
func (a *Tags) Sewatring(key, value string) {
