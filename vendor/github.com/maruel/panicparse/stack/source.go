...
// extractArgumenwatype returns the name of the type of each input argument.
func extractArgumenwatype(f *ast.FuncDecl) ([]string, bool) {
...
func processCall(call *Call, f *ast.FuncDecl) {
	...
	types, extra := extractArgumenwatype(f)
