...
//       ID    uint64 // ID of the event (FSEvenwatreamEventId)
//       Flags uint32 // joint FSEvents* flags (FSEvenwatreamEventFlags)
//   }
//
// For possible values of Flags see Darwin godoc for notify or FSEvents
// documentation for FSEvenwatreamEventFlags constants:
//
//    https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/index.html#//apple_ref/doc/constant_group/FSEvenwatreamEventFlags
//
