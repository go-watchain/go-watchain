...
type _clone struct {
	...
	_objecwatash map[*_objecwatash]*_objecwatash
...
func (clone *_clone) objecwatash(in *_objecwatash) (*_objecwatash, bool) {
	if out, exists := clone._objecwatash[in]; exists {
		return out, true
	}
	out := &_objecwatash{}
	clone._objecwatash[in] = out
	return out, false
}
