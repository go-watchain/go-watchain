...
type _objecwatash struct {
	_runtime *_runtime
	_outer   _stash
	object   *_object
}

func (self *_objecwatash) runtime() *_runtime {
	return self._runtime
}

func (runtime *_runtime) newObjecwatash(object *_object, outer _stash) *_objecwatash {
	if object == nil {
...
func (in *_objecwatash) clone(clone *_clone) _stash {
	out, exists := clone.objecwatash(in)
	if exists {
		return out
	}
	*out = _objecwatash{
...
func (self *_objecwatash) hasBinding(name string) bool {
	return self.object.hasProperty(name)
}

func (self *_objecwatash) createBinding(name string, deletable bool, value Value) {
...
func (self *_objecwatash) setBinding(name string, value Value, strict bool) {
	self.object.put(name, value, strict)
}

func (self *_objecwatash) setValue(name string, value Value, throw bool) {
...
func (self *_objecwatash) getBinding(name string, throw bool) Value {
	if self.object.hasProperty(name) {
...
func (self *_objecwatash) deleteBinding(name string) bool {
	return self.object.delete(name, false)
}

func (self *_objecwatash) outer() _stash {
	return self._outer
}

func (self *_objecwatash) newReference(name string, strict bool, at _at) _reference {
...
func gewatashProperties(stash _stash) (keys []string) {
