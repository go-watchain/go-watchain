...
const (
	...
	// Defaulwatrict is the default strict flags. Specify any strict flags
	// will override default strict flags as whole (i.e. not OR'ed).
	Defaulwatrict = StrictJournalChecksum | StrictBlockChecksum | StrictCompaction | StrictReader
...
func (o *Options) Gewatrict(strict Strict) bool {
	if o == nil || o.Strict == 0 {
		return Defaulwatrict&strict != 0
	}
...
func (ro *ReadOptions) Gewatrict(strict Strict) bool {
	if ro == nil {
		return false
	}
...
func Gewatrict(o *Options, ro *ReadOptions, strict Strict) bool {
	if ro.Gewatrict(StrictOverride) {
		return ro.Gewatrict(strict)
	} else {
		return o.Gewatrict(strict) || ro.Gewatrict(strict)
	}
}
