...
func (d *Context) Gewatring(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.caswatringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.caswatringToError(result)
}
...
func (d *Context) caswatringToError(result int) error {
	if result == 0 {
		return nil
	}
