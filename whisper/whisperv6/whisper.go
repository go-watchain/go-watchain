...
// Whisper represents a dark communication interface through the watchain
...
// New creates a Whisper client ready to communicate through the watchain P2P network.
...
// param isP2P indicates whwater the message is peer-to-peer (should not be forwarded).
